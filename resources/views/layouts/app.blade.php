...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/logocw.png') }}">
    ...
    {{-- Select2 --}}
    <link href="https://cdn.jsdelivr.netA/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
